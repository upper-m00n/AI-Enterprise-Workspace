        ...
        <div className="w-full max-w-[440px] flex flex-col gap-6">
          <div className="bg-white border border-slate-200 rounded-xl p-8 auth-card-shadow transition-all duration-300">
            ...
            <header className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-lg font-bold text-slate-900 tracking-tight">Enterprise AI Workspace</h1>
              <p className="text-xs text-slate-500 mt-1">Welcome Back</p>
            </header>

            {error && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg text-red-800 text-xs flex items-center gap-3">
            ...
            <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider" htmlFor="password">Password</label>
                  <span className="text-[10px] font-semibold text-primary hover:underline transition-all cursor-pointer">Forgot Password?</span>
                </div>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-primary transition-colors">
                    <Lock size={16} />
            ...
            <div className="grid grid-cols-2 gap-3 text-xs font-semibold">
              <button className="flex items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 transition-colors group">
              ...
              <button className="flex items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 transition-colors group">
                <Key size={14} className="text-primary group-hover:scale-110 transition-transform" />
                <span>SSO</span>
              </button>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-xs text-slate-500">
              ...
              <Link className="font-bold text-primary hover:underline transition-all ml-1" to="/register">Register</Link>
            </p>
          </div>
        </div>
      </main>
